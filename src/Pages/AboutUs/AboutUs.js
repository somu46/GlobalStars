    ...
    <div className="min-h-screen bg-amber-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-700 text-lg leading-relaxed max-w-3xl mx-auto">
            Established in 1952, Timeless Treasures has been a guardian of history, specializing in the acquisition and 
            preservation of exceptional antiques. For three generations, our family has connected collectors with 
            extraordinary pieces that whisper stories of bygone eras.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
          <div className="space-y-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-amber-800">Heritage Preservation</h3>
                <p className="text-gray-700">
                  Committed to maintaining historical integrity through meticulous conservation practices
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-amber-800">Historical Authentication</h3>
                <p className="text-gray-700">
                  Comprehensive provenance research and certification for every artifact
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Why Choose Us */}
        <div className="text-center mb-16">
          <h2 className="text-3xl font-serif text-amber-800 mb-6">Why Collectors Trust Us</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-24">
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border-t-4 border-amber-600">
            ...
            <h3 className="text-xl font-bold mb-4 text-amber-800">Expert Authentication</h3>
            <p className="text-gray-700">
              Multi-stage verification process with leading historians and appraisers
            </p>
          </div>

          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border-t-4 border-amber-600">
            <FaSearch className="text-4xl text-amber-600 mb-4" />
            <h3 className="text-xl font-bold mb-4 text-amber-800">Rare Finds</h3>
            <p className="text-gray-700">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border-t-4 border-amber-600">
            ...
            <h3 className="text-xl font-bold mb-4 text-amber-800">Conservation Services</h3>
            <p className="text-gray-700">
              Museum-grade restoration by master craftsmen using traditional techniques
            </p>
          </div>
        </div>
        ...
        <div className="bg-amber-100 py-16 rounded-xl text-center">
          <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="space-y-4">
              ...
              <div className="text-sm uppercase tracking-wide text-gray-700">Years Experience</div>
            </div>
            <div className="space-y-4">
              <div className="text-4xl font-bold text-amber-800">15k+</div>
              <div className="text-sm uppercase tracking-wide text-gray-700">Artifacts Curated</div>
            </div>
            <div className="space-y-4">
              <div className="text-4xl font-bold text-amber-800">98%</div>
              <div className="text-sm uppercase tracking-wide text-gray-700">Accuracy Rate</div>
            </div>
            <div className="space-y-4">
              <div className="text-4xl font-bold text-amber-800">200+</div>
              <div className="text-sm uppercase tracking-wide text-gray-700">Era Specialists</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-amber-800 text-white py-16">
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-3xl font-serif mb-6">Discover Hidden Histories</h2>
